...
![Qwen-TTS voice cloning cover](/static/qwen-tts-voice-clone.png)

*How we turned Qwen3-TTS's 9-voice ceiling into "bring your own voice" — a pure C implementation of ECAPA-TDNN speaker encoding, a portable `.qvoice` file format, and three storage tiers with real audio side-by-side so you can hear the trade-off.*
...
All audio below is hosted in the [qwen3-tts repo](https://github.com/gabriele-mastrapasqua/qwen3-tts/tree/main/samples/voice_clone_refs) — click ▶️ to play.
...
*This is part of the [qwen3-tts](https://github.com/gabriele-mastrapasqua/qwen3-tts) project — a pure C inference engine for Qwen3-TTS text-to-speech models. For the optimization journey that got this engine from RTF 3.5 to RTF 1.26, see the [optimization notes](qwen-tts-optimization-notes.html). For the full weight-analysis story behind WDELTA, see [cross-model-voice-analysis.md](https://github.com/gabriele-mastrapasqua/qwen3-tts/blob/main/blog/cross-model-voice-analysis.md).*
